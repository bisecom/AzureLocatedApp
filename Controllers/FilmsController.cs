...
using FilmsDbAzureApp.Models;
using System.IO;

namespace FilmsDbAzureApp.Controllers
{
    public class FilmsController : Controller
    {
        ...
        //    }
        //    Film film = await db.Products.FindAsync(id);
        //    if (film == null)
        //    {
        //        return HttpNotFound();
        //    }
        ...
        //public async Task<ActionResult> Create([Bind(Include = "Id,Genre,Title,Production,Country,Year,Cast,Picture,Price")] Film film)
        //{
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<ActionResult> Edit([Bind(Include = "Id,Genre,Title,Production,Country,Year,Cast,Picture,Price")] Film film)
        //{
        //    if (ModelState.IsValid)
        //    {
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            Film product = await db.Products.FindAsync(id);
            if (product == null)
            {
                return HttpNotFound();
            }
